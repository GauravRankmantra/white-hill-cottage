  ...
  return (
    <section className="">
      <div className="flex my-4 flex-col md:flex-row justify-between items-start md:items-center mb-8">
        <div>
          <p className="text-gray-500 text-lg">Join Us</p>
          <h2 className="text-4xl font-bold font-ralewayB text-[#1d1d1d]">
            Escape to Nature,
          </h2>
          <h2 className="text-6xl font-ralewayB font-bold text-[#1d1d1d]">
            Experience the Adventure!
          </h2>
        </div>
        <p className="text-gray-500 md:w-2/5 font-ralewayL  mt-2 md:mt-0">
